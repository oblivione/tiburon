...
class pidPanel(QtGui.QMainWindow):
    ...
    def yawCallback(self,msg):
        self.ui.ckpoint_lineEdit.setText(str(msg.YPR.x)) 
    ...
    def srv_y_callback(self,msg):
        #print msg.doubles
        self.ui.kp_yaw_lineEdit.setText(str(msg.doubles[3].value)) #kp
        self.ui.ki_yaw_lineEdit.setText(str(msg.doubles[4].value)) #ki
        self.ui.kd_yaw_lineEdit.setText(str(msg.doubles[7].value)) #kd
    ...
    def srv_d_callback(self,msg):
        ...
        self.ui.kp_depth_lineEdit.setText(str(msg.doubles[3].value)) #kp
        self.ui.ki_depth_lineEdit.setText(str(msg.doubles[0].value)) #ki
        self.ui.kd_depth_lineEdit.setText(str(msg.doubles[2].value)) #kd
    ...
    def srv_p_callback(self,msg):
        ...
        self.ui.kp_pitch_lineEditlineEdi.setText(str(msg.doubles[1].value)) #kp
        self.ui.ki_pitch_lineEdit.setText(str(msg.doubles[3].value)) #ki
        self.ui.kd_pitch_lineEdit.setText(str(msg.doubles[2].value)) #kd
        setpoint_pitch = msg.doubles[4].value
        print setpoint_pitch
